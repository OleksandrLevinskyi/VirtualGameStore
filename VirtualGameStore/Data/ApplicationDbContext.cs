    ...
    public class ApplicationDbContext : IdentityDbContext<User> {
        ...
        private static void Seed(ModelBuilder builder) {
            ...
            var employeeUser = new User() {
                ...
                EmailConfirmed = true,
                PasswordHash =
                    "AQAAAAEAACcQAAAAEGiel0OKEa5+pKsFTlka1xHjptYHOzHiRtImi2E8QYR4dgXVvcAFZm1AA7wKbxO9ew==", // Password1!
            ...
            var events = new List<Event>() {
                ...
                new Event() {
                    ...
                    Name = "Holiday Trivia",
                    Description =
                        "Come join us for some virtual pub trivia! Show up solo or with a team — and join the league to be eligible for big prizes!",
                    AttendeeLimit = 16,
                    CreatorId = employeeUser.Id,
